...
<body>
	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html">坤坤客户列表页面</a>
		</div>
		<!-- /.navbar-header -->
		...
		<ul class="nav navbar-top-links navbar-right">
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-messages">
					<li><a href="#">
							<div>
								<strong>经理</strong> <span class="pull-right text-muted">
									<em>昨天</em>
								</span>
							</div>
							<div>系统上线</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<a url="${pageContext.request.contextPath }/customer/list.action" >显示</a>
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
